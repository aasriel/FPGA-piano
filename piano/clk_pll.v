...
/* Module Version: 5.7 */
/* D:\lattice diamond\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n clk_pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 48 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Fri Jul 22 19:06:45 2022 */


`timescale 1 ns / 1 ps
module clk_pll (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
